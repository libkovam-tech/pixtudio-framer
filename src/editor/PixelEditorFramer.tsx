        ...
        <InlineSvgWrap style={style} ariaLabel="Top button 3">
            ...
            >
                <g>
                    ...
                    <path
                        fill="#fff"
                        d="M96.54,93.2h-61.34v-13.14h6.8v6.34h47.74v-6.34h6.8v13.14h0ZM65.87,80.96l-21.88-21.88,4.81-4.81,13.68,13.68v-34.65h6.8v34.65l13.68-13.68,4.81,4.81-21.88,21.88h-.02Z"
                    />
                </g>
            </svg>
        </InlineSvgWrap>
        ...
        <InlineSvgWrap style={style} ariaLabel="Top button 4">
            ...
            >
                <g>
                    ...
                    <path
                        fill="#fff"
                        d="M96.54,93.2h-61.34v-13.14h6.8v6.34h47.74v-6.34h6.8v13.14h0ZM65.87,33.3l-21.88,21.88,4.81,4.81,13.68-13.68v34.65h6.8v-34.65l13.68,13.68,4.81-4.81-21.88-21.88h-.02Z"
                    />
                </g>
            </svg>
        </InlineSvgWrap>
...
function SvgManualButton({ style }: { style?: React.CSSProperties }) {
    return (
...
function PixelEditorFramer({
    ...
    function decodeRefToImageData(
        ...
        // ImageData ждёт Uint8ClampedArray; делаем явное приведение через копию
        const clamped =
            bytes instanceof Uint8ClampedArray ? bytes : new Uint8ClampedArray(bytes as any)
        return new ImageData(clamped, 512, 512)
    }
    ...
    function commitHexDraft() {
        ...
        if (/^#[0-9A-F]{6}$/.test(norm)) {
            ...
            if (!rgb) return // на всякий случай (hexToRgb может вернуть null)
...
export default function PIXTUDIO_Mobile_MVP() {
    ...
    function renderCropPreview() {
        ...
        function drawTransformed(ctx2: CanvasRenderingContext2D, alpha: number) {
            ctx2.save()
            ctx2.globalAlpha = alpha
            ctx2.translate(cx, cy)
            ctx2.rotate(cropUiRotation)
            ctx2.drawImage(src, -drawW / 2, -drawH / 2, drawW, drawH)
            ctx2.restore()
        }

        // 1) "уши": рисуем ту же картинку, но с opacity ~30% (без клипа)
        drawTransformed(ctx, IMPORT_PREVIEW_EARS_OPACITY)
