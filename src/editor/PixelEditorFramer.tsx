...
function SvgTopButton3({ style }: { style?: React.CSSProperties }) {
    return (
        <InlineSvgWrap style={style} ariaLabel="Top button 3">
            ...
            >
                <g>
                    ...
                    <path
                        fill="#fff"
                        d="M76.61,75.74h-5.36v5.34h-10.75v-5.32h-5.39v-5.39h-5.39v-5.39h-5.39v-5.39h-5.37v-10.73h10.66v5.3h5.42v5.39h5.43V26.69h10.74v32.84h5.43v-5.32h5.39v-5.36h10.71v10.64h-5.29v5.39h-5.42v5.42h-5.42v5.42Z"
                    />
                    <path
                        fill="#fff"
                        d="M33.5,102.64v-5.31h-5.33v-10.71h10.65v5.27h54.01v-5.29h10.72v10.66h-5.31v5.37H33.5Z"
                    />
                </g>
            </svg>
        </InlineSvgWrap>
...
function SvgTopButton4({ style }: { style?: React.CSSProperties }) {
    return (
        <InlineSvgWrap style={style} ariaLabel="Top button 4">
            ...
            >
                <g>
                    ...
                    <path
                        fill="#fff"
                        d="M55.08,32.03h5.36v-5.34h10.75v5.32h5.39v5.39h5.39v5.39h5.39v5.39h5.37v10.73h-10.66v-5.3h-5.42v-5.39h-5.43v32.84h-10.74v-32.84h-5.43v5.32h-5.39v5.36h-10.71v-10.64h5.29v-5.39h5.42v-5.42h5.42v-5.42Z"
                    />
                    <path
                        fill="#fff"
                        d="M33.5,102.64v-5.31h-5.33v-10.71h10.65v5.27h54.01v-5.29h10.72v10.66h-5.31v5.37H33.5Z"
...
function SvgCancelButton({ style }: { style?: React.CSSProperties }) {
    return (
        <svg
...
function SvgFolder(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 245.52 190.64" {...props}>
            <path
...
function PixelEditorFramer({
    ...
    type ImportStatus = "idle" | "decoding" | "ready" | "applying" | "error"
    ...
    function applyLoadLetterInEditor(letter: LoadLetter) {
        ...
        if (!letter.ok) {
            ...
            setImportError("IMPORT ERROR, попробуем ещё раз")
            return
        }
    ...
    function dismissImportErrorModal() {
        setImportStatus("idle")
        setImportError(null)
    }
    ...
    const SaveIcon = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 131.73 131.73"
        ...
        >
            ...
            <path
                fill="#fff"
                d="M51.69,2.72V0H2.72v2.72H0v46.25h2.72v2.72h2.72v2.72h2.72v2.72h43.53v-2.72h2.72V2.72h-2.72ZM43.53,51.69H10.88v-19.04h32.65v19.04ZM43.53,24.48H10.88V5.44h32.65v19.04Z"
            />
        </svg>
    )

    const LoadIcon = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
        ...
        >
            ...
            <path
                fill="#BB3E03"
                d="M0,0h129.81v129.81H0V0z M9.28,9.28v111.25h111.25V9.28H9.28z"
            />
            {/* “папка” */}
            <path fill="#FFFFFF" d="M24 40h30l6 8h45v54H24V40z" />
            {/* стрелка вниз */}
            <rect
                x="60"
                y="54"
                ...
                opacity="0.7"
            />
            <path fill="#001219" opacity="0.7" d="M52 74h26v10H52V74z" />
            <path fill="#001219" opacity="0.7" d="M50 70h30l-15 18-15-18z" />
        </svg>
    )

    const UndoIcon = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 131.73 131.73"
        ...
        >
            ...
            <polygon
                fill="#fff"
                points="53.77 30.75 53.77 33.35 56.37 33.35 56.37 35.95 58.97 35.95 58.97 38.55 61.57 38.55 61.57 43.75 58.97 43.75 58.97 46.35 56.37 46.35 56.37 48.95 53.77 48.95 53.77 51.56 51.16 51.56 51.16 54.16 84.98 54.16 84.98 56.76 87.58 56.76 87.58 59.36 92.79 59.36 92.79 61.96 95.39 61.96 95.39 67.16 97.99 67.16 97.99 100.98 84.98 100.98 84.98 74.97 82.38 74.97 82.38 69.77 77.18 69.77 77.18 67.16 51.16 67.16 51.16 72.37 53.77 72.37 53.77 74.97 56.37 74.97 56.37 77.57 58.97 77.57 58.97 80.17 61.57 80.17 61.57 82.77 58.97 82.77 58.97 85.37 56.37 85.37 56.37 87.98 53.77 87.98 53.77 90.58 48.56 90.58 48.56 87.98 45.96 87.98 45.96 85.37 43.36 85.37 43.36 82.77 40.76 82.77 40.76 80.17 38.16 80.17 38.16 77.57 35.56 77.57 35.56 74.97 32.95 74.97 32.95 72.37 30.35 72.37 30.35 69.77 27.75 69.77 27.75 67.16 25.15 67.16 25.15 61.96 22.55 61.96 22.55 59.36 25.15 59.36 25.15 56.76 27.75 56.76 27.75 54.16 30.35 54.16 30.35 51.56 32.95 51.56 32.95 48.95 35.56 48.95 35.56 46.35 38.16 46.35 38.16 43.75 40.76 43.75 40.76 41.15 43.36 41.15 43.36 38.55 45.96 38.55 45.96 35.95 48.56 35.95 48.56 33.35 51.16 33.35 51.16 30.75 53.77 30.75"
            />
        </svg>
    )

    const RedoIcon = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 131.73 131.73"
        ...
        >
            ...
            <polygon
                fill="#fff"
                points="77.96 30.75 77.96 33.35 75.36 33.35 75.36 35.95 72.76 35.95 72.76 38.55 70.16 38.55 70.16 43.75 72.76 43.75 72.76 46.35 75.36 46.35 75.36 48.95 77.96 48.95 77.96 51.56 80.56 51.56 80.56 54.16 46.75 54.16 46.75 56.76 44.14 56.76 44.14 59.36 38.94 59.36 38.94 61.96 36.34 61.96 36.34 67.16 33.74 67.16 33.74 100.98 46.75 100.98 46.75 74.97 49.35 74.97 49.35 69.77 54.55 69.77 54.55 67.16 80.56 67.16 80.56 72.37 77.96 72.37 77.96 74.97 75.36 74.97 75.36 77.57 72.76 77.57 72.76 80.17 70.16 80.17 70.16 82.77 72.76 82.77 72.76 85.37 75.36 85.37 75.36 87.98 77.96 87.98 77.96 90.58 83.16 90.58 83.16 87.98 85.77 87.98 85.77 85.37 88.37 85.37 88.37 82.77 90.97 82.77 90.97 80.17 93.57 80.17 93.57 77.57 96.17 77.57 96.17 74.97 98.77 74.97 98.77 72.37 101.37 72.37 101.37 69.77 103.98 69.77 103.98 67.16 106.58 67.16 106.58 61.96 109.18 61.96 109.18 59.36 106.58 59.36 106.58 56.76 103.98 56.76 103.98 54.16 101.37 54.16 101.37 51.56 98.77 51.56 98.77 48.95 96.17 48.95 96.17 46.35 93.57 46.35 93.57 43.75 90.97 43.75 90.97 41.15 88.37 41.15 88.37 38.55 85.77 38.55 85.77 35.95 83.16 35.95 83.16 33.35 80.56 33.35 80.56 30.75 77.96 30.75"
            />
        </svg>
    )

    const ZoomOutIcon = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 129.81 129.81"
    ...
    const ZoomInIcon = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 129.81 129.81"
        ...
        >
            ...
            <polygon
                fill="#ffffff"
                points="69.54 33.28 51 33.28 51 51 33.28 51 33.28 69.54 51 69.54 51 87.25 69.54 87.25 69.54 69.54 87.25 69.54 87.25 51 69.54 51 69.54 33.28"
            />
        </svg>
    )
        ...
        if (active) {
            ...
            return (
                ...
                >
                    ...
                    <path
                        d="M5.47,151.32h118.56V5.47H5.47v145.85Z"
                        fill="#fff"
                    />
                    ...
                    <g>
                        <g>
                            <path
                                fill="#031219"
                                d="M19.57,98.33h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66s0-2.66,0-2.66h2.66v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v2.66s2.66,0,2.66,0v5.32h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-2.66s0,2.66,0,2.66h-18.6v2.66s-2.66,0-2.66,0v2.66s-2.66,0-2.66,0v2.66s-2.66,0-2.66,0v-2.66s-2.66,0-2.66,0v-2.66s-2.66,0-2.66,0v-5.32h2.66s0-2.66,0-2.66h2.66s0-15.95,0-15.95h2.66v-5.32Z"
                            />
                            <polygon
                                fill="#031219"
                                points="107.28 23.91 107.28 26.57 112.59 26.57 112.59 29.23 115.25 29.23 115.25 34.54 117.91 34.54 117.91 50.49 115.25 50.49 115.25 53.15 112.59 53.15 112.59 55.81 109.93 55.8 109.94 58.46 107.28 58.46 107.28 61.12 104.62 61.12 104.62 63.78 101.96 63.78 101.96 66.44 104.62 66.43 104.62 69.09 107.28 69.09 107.28 77.07 104.62 77.06 104.62 79.72 99.3 79.72 99.3 77.06 96.64 77.07 96.65 74.41 93.99 74.41 93.99 71.75 91.33 71.75 91.33 69.09 88.67 69.09 88.67 66.43 86.01 66.44 86.02 63.78 83.36 63.78 83.36 61.12 80.7 61.12 80.7 58.46 78.04 58.46 78.04 55.8 75.38 55.81 75.39 53.15 72.72 53.15 72.73 50.49 70.07 50.49 70.07 47.83 67.41 47.83 67.41 45.17 64.75 45.17 64.75 37.2 75.38 37.2 75.38 39.86 80.7 39.86 80.7 37.2 83.36 37.2 83.36 34.54 86.02 34.54 86.01 31.88 88.67 31.89 88.67 29.23 91.33 29.23 91.33 26.57 96.65 26.57 96.65 23.91 107.28 23.91"
                            />
                        </g>

                        <polygon
                            fill="#fff"
                            points="27.54 106.3 27.54 111.62 30.2 111.62 30.2 114.27 38.18 114.27 38.17 111.62 40.83 111.62 40.83 108.96 43.49 108.96 43.49 106.3 46.15 106.3 46.15 103.64 48.81 103.65 48.8 100.98 51.47 100.99 51.46 98.33 54.12 98.33 54.12 95.67 56.78 95.67 56.78 93.01 59.44 93.01 59.44 90.35 62.1 90.36 62.09 87.7 64.75 87.7 64.75 85.04 67.41 85.04 67.41 82.38 70.07 82.38 70.07 79.72 72.73 79.72 72.73 74.41 70.07 74.41 70.07 71.75 67.41 71.75 67.41 69.09 64.75 69.09 64.75 71.75 62.09 71.75 62.1 74.41 59.44 74.41 59.44 77.07 56.78 77.06 56.78 79.73 54.12 79.72 54.12 82.38 51.46 82.38 51.47 85.04 48.8 85.04 48.81 87.7 46.15 87.7 46.15 90.36 43.49 90.35 43.49 93.01 40.83 93.01 40.83 95.67 38.17 95.67 38.18 98.33 35.52 98.33 35.52 100.99 32.86 100.98 32.86 103.65 30.2 103.64 30.2 106.3 27.54 106.3"
                        />
                    </g>
                </svg>
            )
        ...
        return (
            ...
            >
                <g>
                    <path
                        fill="#031219"
                        d="M8.76,81.76h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v-2.92h2.92v2.92h2.92v2.92h2.92v2.92h2.92v2.92h2.92v2.92h2.92v2.92h2.92v2.92h2.92v5.84h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92h-2.92v2.92H14.6v2.92h-2.92v2.92h-2.92v2.92h-2.92v-2.92h-2.92v-2.92H0v-5.84h2.92v-2.92h2.92v-17.52h2.92s0-5.84,0-5.84Z"
                    />
                    <polygon
                        fill="#031219"
                        points="105.12 0 105.12 2.92 110.96 2.92 110.96 5.84 113.88 5.84 113.88 11.68 116.8 11.68 116.8 29.2 113.88 29.2 113.88 32.12 110.96 32.12 110.96 35.04 108.04 35.04 108.04 37.96 105.12 37.96 105.12 40.88 102.2 40.88 102.2 43.8 99.28 43.8 99.28 46.72 102.2 46.72 102.2 49.64 105.12 49.64 105.12 58.4 102.2 58.4 102.2 61.32 96.36 61.32 96.36 58.4 93.44 58.4 93.44 55.48 90.52 55.48 90.52 52.56 87.6 52.56 87.6 49.64 84.68 49.64 84.68 46.72 81.76 46.72 81.76 43.8 78.84 43.8 78.84 40.88 75.92 40.88 75.92 37.96 73 37.96 73 35.04 70.08 35.04 70.08 32.12 67.16 32.12 67.16 29.2 64.24 29.2 64.24 26.28 61.32 26.28 61.32 23.36 58.4 23.36 58.4 14.6 70.08 14.6 70.08 17.52 75.92 17.52 75.92 14.6 78.84 14.6 78.84 11.68 81.76 11.68 81.76 8.76 84.68 8.76 84.68 5.84 87.6 5.84 87.6 2.92 93.44 2.92 93.44 0 105.12 0"
                    />
                </g>

                <polygon
                    fill="#fff"
                    points="17.52 90.52 17.52 96.36 20.44 96.36 20.44 99.28 29.2 99.28 29.2 96.36 32.12 96.36 32.12 93.44 35.04 93.44 35.04 90.52 37.96 90.52 37.96 87.6 40.88 87.6 40.88 84.68 43.8 84.68 43.8 81.76 46.72 81.76 46.72 78.84 49.64 78.84 49.64 75.92 52.56 75.92 52.56 73 55.48 73 55.48 70.08 58.4 70.08 58.4 67.16 61.32 67.16 61.32 64.24 64.24 64.24 64.24 61.32 67.16 61.32 67.16 55.48 64.24 55.48 64.24 52.56 61.32 52.56 61.32 49.64 58.4 49.64 58.4 52.56 55.48 52.56 55.48 55.48 52.56 55.48 52.56 58.4 49.64 58.4 49.64 61.32 46.72 61.32 46.72 64.24 43.8 64.24 43.8 67.16 40.88 67.16 40.88 70.08 37.96 70.08 37.96 73 35.04 73 35.04 75.92 32.12 75.92 32.12 78.84 29.2 78.84 29.2 81.76 26.28 81.76 26.28 84.68 23.36 84.68 23.36 87.6 20.44 87.6 20.44 90.52 17.52 90.52"
                />
            </svg>
        )
    }

    const HandIconOn = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
            viewBox="0 0 129.51 156.79"
        ...
        >
            ...
            <polygon
                fill="#056074"
                points="54.52 139.75 54.52 135.42 40.89 135.42 40.89 131.1 36.34 131.1 36.34 126.78 31.8 126.78 31.8 118.14 27.25 118.14 27.25 105.17 22.7 105.17 22.7 92.2 18.16 92.2 18.16 79.23 13.61 79.23 13.61 68.91 28.7 68.91 28.7 73.23 33.25 73.23 33.25 86.2 37.8 86.2 37.8 94.85 40.89 94.85 40.89 30.01 45.43 30.01 45.43 25.69 55.98 25.69 55.98 73.23 59.07 73.23 59.07 17.05 74.16 17.05 74.16 73.23 77.25 73.23 77.25 21.37 87.8 21.37 87.8 25.69 92.34 25.69 92.34 77.56 95.43 77.56 95.43 38.66 105.98 38.66 105.98 42.98 110.52 42.98 110.52 109.49 105.98 109.49 105.98 122.46 101.43 122.46 101.43 126.78 96.89 126.78 96.89 131.1 92.34 131.1 92.34 135.42 78.7 135.42 78.7 139.75 54.52 139.75"
            />
        </svg>
    )

    const HandIconOff = ({ size = 90 }: { size?: number }) => (
        <svg
            width={size}
            height={size}
        ...
        >
            <polygon
                fill="#056074"
                points="43.22 119.72 43.22 116.12 28.82 116.12 28.82 112.52 25.21 112.52 25.21 108.92 18.01 108.92 18.01 101.71 14.41 101.71 14.41 94.51 10.81 94.51 10.81 83.71 7.2 83.71 7.2 72.9 3.6 72.9 3.6 65.7 0 65.7 0 50.43 3.6 50.43 3.6 46.82 21.61 46.82 21.61 18.01 25.21 18.01 25.21 14.41 28.82 14.41 28.82 10.81 36.02 10.81 36.02 7.2 39.62 7.2 39.62 3.6 43.22 3.6 43.22 0 54.89 0 54.89 3.6 58.49 3.6 58.49 7.2 69.3 7.2 69.3 10.81 72.9 10.81 72.9 14.41 76.5 14.41 76.5 21.61 83.71 21.61 83.71 25.21 87.31 25.21 87.31 28.82 90.91 28.82 90.91 87.31 87.31 87.31 87.31 98.11 83.71 98.11 83.71 105.32 80.1 105.32 80.1 108.92 76.5 108.92 76.5 112.52 69.3 112.52 69.3 116.12 58.49 116.12 58.49 119.72 43.22 119.72"
            />
            <polygon
                fill="#fff"
                points="52.66 13.04 45.46 13.04 45.46 59.86 38.25 59.86 38.25 20.24 34.65 20.24 34.65 23.84 31.05 23.84 31.05 77.87 23.84 77.87 23.84 70.67 20.24 70.67 20.24 59.86 16.64 59.86 16.64 56.26 9.44 56.26 9.44 59.86 13.04 59.86 13.04 70.67 16.64 70.67 16.64 81.47 20.24 81.47 20.24 92.28 23.84 92.28 23.84 99.48 27.45 99.48 27.45 103.08 31.05 103.08 31.05 106.69 41.85 106.69 41.85 110.29 56.26 110.29 56.26 106.69 67.07 106.69 67.07 103.08 70.67 103.08 70.67 99.48 74.27 99.48 74.27 95.88 77.87 95.88 77.87 85.08 81.47 85.08 81.47 34.65 77.87 34.65 77.87 31.05 74.27 31.05 74.27 63.46 67.07 63.46 67.07 20.24 63.46 20.24 63.46 16.64 59.86 16.64 59.86 59.86 52.66 59.86 52.66 13.04"
            />
        </svg>
    )
    ...
    React.useEffect(() => {
        ...
        try {
            if (originalImageData) {
                ...
                traceLoad("repixelizeEffect MUTATE", {
                    step: "setAutoSwatches (with-original)",
                    n: nextAutoEffective.length,
                })
                setAutoSwatches(nextAutoEffective)
                ...
                setImagePixels((prev) => {
                    const imageNext = resizePixels(prev, gridSize)
                    ...
                    const nextAuto: Swatch[] = colors.map((c, i) => ({
                        id: `auto-${i}`,
                        color: c,
                        isTransparent: false,
                        isUser: false,
                    ...
                    traceLoad("repixelizeEffect MUTATE", {
                        step: "setAutoSwatches (no-original)",
                        n: nextAutoEffective.length,
                    })
                    setAutoSwatches(nextAutoEffective)

                    traceLoad("repixelizeEffect MUTATE", {
                        step: "setSelectedSwatch (no-original)",
                    })
    ...
    useIsomorphicLayoutEffect(() => {
        ...
        // 2) ещё раз на следующий кадр (на случай поздней раскладки/шрифтов)
        const raf = window.requestAnimationFrame(updateOverlayAnchor)

        const onReflow = () => updateOverlayAnchor()

        // scroll capture — чтобы ловить скролл любых контейнеров
                ...
                >
                    <div style={{ width: "100%", maxWidth: canvasMax }}>
                        ...
                        <div style={{ marginBottom: 18 }}>
                            ...
                            <style>{`
  :root{
    --px-range-thumb: 44px; /* размер кружка */
...
`}</style>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    behaves as empty pixel and will not include
                                    in PNG/SVG
                                </div>
                            </div>
                        </div>
                ...
                {/* Global Import Error Modal (used by L0 fail-closed too) */}
...
export default function PIXTUDIO_Mobile_MVP() {
    ...
    async function handlePickedImage(
        ...
        try {
            ...
            setImportStatus("error")
            setImportError("Failed to open image")
            return
        }
    }
    ...
    async function handlePickedCamera(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        if (!file.type || !file.type.startsWith("image/")) {
            ...
            setImportStatus("error")
            setImportError(CAMERA_IMPORT_ERROR_TEXT)
            return
        }
    ...
    React.useEffect(() => {
        ...
        try {
            ...
            setImportError("Please try importing another image or cancel.")
    ...
    React.useEffect(() => {
        ...
        try {
            ...
            setImportStatus("error")
            setImportError("Failed to bake import artifact")
        } finally {
    ...
    function dismissImportErrorModal() {
        resetImportUi("import-error-dismiss")
    }
    ...
    function confirmCrop() {
        ...
        if (!p) {
            ...
            setImportStatus("error")
            setImportError("Crop parameters missing")
            return
        }
        ...
        if (!prepared) {
            ...
            setImportStatus("error")
            setImportError("Failed to apply crop geometry")
            return
        }
                    ...
                    >
                        ...
                        >
                            {importStatus !== "idle" && (
                                ...
                                >
                                    ...
                                    {importStatus === "applying" &&
                                        "Applying import…"}
                                    {importStatus === "error" &&
                                        `Import failed${importError ? ": " + importError : ""}`}
                                </div>
                            )}
                            ...
                            {importStatus === "error" && (
                                ...
                                >
                                    Please try importing another image or
                                    cancel.
                                </div>
                            )}
