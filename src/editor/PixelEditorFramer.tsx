...
function PixelEditorFramer({
    ...
    function commitPaintRefIfDirty(
        ...
        // Capture both color and transparent stroke references once per stroke end.
        capturePaintRefsFromOverlay({
            overlay: overlayForRef,
